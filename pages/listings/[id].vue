  ...
  <div class="min-h-screen">
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-4 stagger">
      ...
      <div class="dash-kpi dash-kpi--blue">
        ...
        <div class="dash-kpi__body">
          <div class="dash-kpi__value">{{ listing?.area || '—' }}<span class="text-sm">m²</span></div>
      ...
      <div class="dash-kpi dash-kpi--amber">
        ...
        <div class="dash-kpi__body">
          <div class="dash-kpi__value">{{ listing?.viewsCount || 0 }}</div>
      ...
      <div class="dash-kpi dash-kpi--blue">
        ...
        <div class="dash-kpi__body">
          <div class="dash-kpi__value">{{ listing?.offerType === 'SALE' ? 'Sotuv' : 'Ijara' }}</div>
          <div class="dash-kpi__label">Turi</div>
        </div>
      </div>
    </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div class="lg:col-span-2 space-y-6">
            <div>
              ...
              <h1 class="text-3xl font-bold text-ink-900  mb-2">{{ listing.titleUz }}</h1>
