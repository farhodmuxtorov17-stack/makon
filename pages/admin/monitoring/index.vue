  ...
  <div class="space-y-5">
    ...
    <div class="card-premium p-5">
      <div class="flex items-center justify-between mb-4">
        <h3 class="font-semibold text-ink-900 ">API javob vaqti (24 soat)</h3>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
      <!-- Online users -->
      <div class="card-premium p-5">
        <h3 class="font-semibold text-ink-900  mb-4">Online foydalanuvchilar</h3>
        <div class="space-y-2">
          <div v-for="u in onlineUsers" :key="u.id" @click="viewUserProfile(u.id)" class="flex items-center gap-3 p-3 rounded-xl hover:bg-brand-500/5 cursor-pointer transition-colors">
            ...
            <div class="flex-1 min-w-0">
              <div class="text-sm font-medium text-ink-900  truncate">{{ u.name }}</div>
      ...
      <!-- Error log -->
      <div class="card-premium p-5">
        <h3 class="font-semibold text-ink-900  mb-4">So'nggi xatolar</h3>
        <div class="space-y-2">
          <div v-for="err in visibleErrors" :key="err.id" class="p-3 rounded-xl bg-red-500/5 border border-red-500/10">
            <div class="flex items-start gap-3">
              ...
              <div class="flex-1">
                <div class="text-sm font-medium text-ink-900 ">{{ err.title }}</div>
