<template>
  <div class="space-y-6">
    ...
    <div class="flex flex-wrap items-center gap-3">
      <div class="stat-pill">
        <div class="stat-pill__icon" style="background: rgba(37,99,235,0.1); color: var(--accent);"><Building2 :size="18" /></div><KpiScene3D type="buildings" :size="40" style="position:absolute;top:-2px;right:-2px;opacity:0.35;pointer-events:none" />
        <div>
      ...
      <div class="stat-pill">
        <div class="stat-pill__icon" style="background: rgba(99,102,241,0.1); color: #6366f1;"><Layers :size="18" /></div><KpiScene3D type="units" :size="40" style="position:absolute;top:-2px;right:-2px;opacity:0.35;pointer-events:none" />
        <div>
      ...
      <div class="stat-pill">
        <div class="stat-pill__icon" style="background: rgba(245,158,11,0.1); color: #f59e0b;"><Box :size="18" /></div><KpiScene3D type="inventory" :size="40" style="position:absolute;top:-2px;right:-2px;opacity:0.35;pointer-events:none" />
        <div>
      ...
      <div class="stat-pill">
        <div class="stat-pill__icon" style="background: rgba(16,185,129,0.1); color: #10b981;"><Check :size="18" /></div><KpiScene3D type="occupancy" :size="40" style="position:absolute;top:-2px;right:-2px;opacity:0.35;pointer-events:none" />
        <div>
