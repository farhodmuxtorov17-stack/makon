<template>
  ...
  <div class="space-y-6 animate-fade-up">
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-4 stagger stagger">
      <div class="dash-kpi dash-kpi--blue">
        ...
        <div class="dash-kpi__body">
          <div class="dash-kpi__value">{{ makonStore.listings.length }}</div>
          <div class="dash-kpi__label">Jami listinglar</div>
        </div>
      </div>
      <div class="dash-kpi dash-kpi--emerald">
        ...
        <div class="dash-kpi__body">
          <div class="dash-kpi__value">{{ publishedCount }}</div>
          <div class="dash-kpi__label">Nashr qilingan</div>
        </div>
      ...
      <div class="dash-kpi dash-kpi--amber">
        ...
        <div class="dash-kpi__body">
          <div class="dash-kpi__value">{{ draftCount }}</div>
          <div class="dash-kpi__label">Qoralamalar</div>
        </div>
      </div>
      <div class="dash-kpi dash-kpi--blue">
        <div class="dash-kpi__glow"></div>
        ...
        <div class="dash-kpi__body">
          <div class="dash-kpi__value">{{ hiddenCount }}</div>
          <div class="dash-kpi__label">Yashirilgan</div>
        </div>
      </div>
    </div>
    ...
    <CreateListingModal :show="showCreateModal" :buildings="makonStore.buildings" @close="showCreateModal = false" @created="handleCreateListing" />
</div>
  </ClientOnly>
</template>
...
const newListing = ref({
  ...
  photoUrl: '/buildings/real_tashkent-night.jpg',
  virtualTourUrl: '',
...
const publishedCount = computed(() => makonStore.listings.filter(l => l.status === 'PUBLISHED').length)
const draftCount = computed(() => makonStore.listings.filter(l => l.status === 'DRAFT').length)
const hiddenCount = computed(() => makonStore.listings.filter(l => l.status === 'HIDDEN' || l.status === 'ARCHIVED').length)
