...
const buildings = [
  { id: 'b1', name: 'Trilliant Tower', type: 'A+ Biznes markaz', district: 'Yunusobod', city: 'Toshkent', floorsCount: 14, totalArea: '15,800', occupancy: 94, units: 141, published: true, image: 'https://media.base44.com/images/public/6a78058ed735adc07d68319d/65eba1a8b_generated_image.png' },
  { id: 'b2', name: 'Tashkent City IBC', type: 'A klass', district: 'Yashnobod', city: 'Toshkent', floorsCount: 22, totalArea: '28,400', occupancy: 87, units: 186, published: true, image: 'https://media.base44.com/images/public/6a78058ed735adc07d68319d/af7261266_generated_image.png' },
  { id: 'b3', name: 'IT Park Tashkent', type: 'IT markaz', district: "Mirzo Ulug'bek", city: 'Toshkent', floorsCount: 8, totalArea: '9,200', occupancy: 92, units: 64, published: true, image: 'https://media.base44.com/images/public/6a78058ed735adc07d68319d/768655312_generated_image.png' },
  { id: 'b4', name: 'Piramit Tower', type: 'Biznes markaz', district: 'Mirobod', city: 'Toshkent', floorsCount: 18, totalArea: '19,600', occupancy: 78, units: 98, published: true, image: 'https://media.base44.com/images/public/6a78058ed735adc07d68319d/d889d0296_generated_image.png' },
  { id: 'b5', name: 'Crystal Plaza', type: 'A klass', district: 'Sergeli', city: 'Toshkent', floorsCount: 12, totalArea: '12,400', occupancy: 84, units: 84, published: true, image: 'https://media.base44.com/images/public/6a78058ed735adc07d68319d/1908acd10_generated_image.png' },
  { id: 'b6', name: 'Nest One Business', type: 'Biznes markaz', district: 'Sergeli', city: 'Toshkent', floorsCount: 9, totalArea: '6.8K', occupancy: 89, units: 54, published: true, image: 'https://media.base44.com/images/public/6a78058ed735adc07d68319d/af7261266_generated_image.png' },
]
</script>
