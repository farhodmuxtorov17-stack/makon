    ...
    <nav class="sticky top-0 z-50 bg-white/95 backdrop-blur-lg border-b border-slate-100">
      <div class="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        <div class="flex items-center gap-2.5">
          <div
            class="w-9 h-9 rounded-xl bg-gradient-to-br from-blue-600 to-indigo-600 flex items-center justify-center shadow-lg shadow-blue-500/20"
          >
        ...
        <div class="flex items-center gap-3">
          <button
            class="hidden sm:flex items-center gap-2 text-sm font-medium text-slate-600 hover:text-slate-900 px-4 py-2.5 rounded-xl border border-slate-200 hover:border-slate-300 transition-colors"
          >
            <span>♡</span> Sevimlilar
          </button>
          <NuxtLink
            to="/login"
            class="text-sm font-semibold text-white px-5 py-2.5 rounded-xl bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 shadow-lg shadow-blue-500/25 transition-all"
          >
            Kirish
          </NuxtLink>
        </div>
    ...
    <section class="max-w-7xl mx-auto px-6 pb-12 grid lg:grid-cols-3 gap-8">
      ...
      <div class="lg:col-span-2 space-y-8">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
          <div class="bg-slate-50 rounded-2xl p-4 text-center">
            <div class="text-2xl font-bold">
              120<span class="text-sm font-normal text-slate-400 ml-1">m²</span>
            </div>
            <div class="text-xs text-slate-400 mt-1">Maydon</div>
          </div>
          <div class="bg-slate-50 rounded-2xl p-4 text-center">
            <div class="text-2xl font-bold">
              3<span class="text-sm font-normal text-slate-400 ml-1">/ 12</span>
            </div>
        ...
        <div>
          ...
          <div
            class="rounded-2xl overflow-hidden border border-slate-200 h-72 relative bg-slate-100"
          >
            <img
              :src="asset('/tashkent/aerial.jpg')"
              alt="Aerial view"
            ...
            <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
              <div
                class="w-12 h-12 rounded-full bg-blue-600 flex items-center justify-center shadow-lg shadow-blue-500/30 border-4 border-white"
              >
          ...
          <div class="bg-white border border-slate-200 rounded-2xl p-6 shadow-lg shadow-slate-100">
            <div class="mb-1">
              <div class="text-3xl font-bold text-slate-900">
                18 000 000 <span class="text-lg font-normal text-slate-400">so'm/oy</span>
              </div>
              <div class="text-sm text-slate-400 mt-1">≈ 150 000 so'm/m² · Depozit: 1 oy</div>
            </div>
            <div class="flex gap-2 mt-5">
              <button
                class="flex-1 bg-gradient-to-r from-blue-600 to-indigo-600 text-white text-sm font-semibold py-3.5 rounded-xl hover:from-blue-700 hover:to-indigo-700 transition-all shadow-lg shadow-blue-500/25"
                @click="openApplication()"
              >
                Ijaraga olish
              </button>
              <button
                class="w-12 h-12 rounded-xl border border-slate-200 flex items-center justify-center hover:bg-slate-50 transition-colors text-lg"
            ...
            <button
              class="w-full mt-2 text-sm font-medium text-slate-600 bg-slate-50 hover:bg-slate-100 py-3 rounded-xl transition-colors"
              @click="showContact = !showContact"
            >
              📞 Bog'lanish
            </button>
          ...
          <div class="bg-white border border-slate-200 rounded-2xl p-5">
            ...
            <div class="space-y-2.5 text-sm">
              <div class="flex justify-between">
                <span class="text-slate-400">Bino nomi</span><span class="font-medium">Green Business Center</span>
              </div>
              <div class="flex justify-between">
                <span class="text-slate-400">Sinfi</span><span class="font-medium">B sinf</span>
              </div>
              <div class="flex justify-between">
                <span class="text-slate-400">Qavatlar soni</span><span class="font-medium">12</span>
              </div>
              <div class="flex justify-between">
                <span class="text-slate-400">Yil</span><span class="font-medium">2024</span>
              </div>
              <div class="flex justify-between">
                <span class="text-slate-400">Parkovka</span><span class="font-medium">150 o'rin</span>
              </div>
            </div>
          </div>
        </div>
